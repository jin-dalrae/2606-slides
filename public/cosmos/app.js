(() => {
  ...
  function UserWavelinePage() {
    ...
    return /* @__PURE__ */ React.createElement("section", { className: "report-section waveline-page waveline-page--document", id: "user-waveline" }, /* @__PURE__ */ React.createElement(ChapterLabel, { number: "04" }, "User waveline"), /* @__PURE__ */ React.createElement("header", { className: "waveline-doc-intro" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "waveline-kicker" }, "Three sessions \xB7 one stage spine"), /* @__PURE__ */ React.createElement("h1", null, "User experience wavelines")), /* @__PURE__ */ React.createElement("p", { className: "waveline-lede" }, "Same eight stages across Cosmos VR, feed platforms, and VR without a game loop. Height is felt intensity \u2014 not time-on-app. Words live in the tables with the chart, not in a hidden hover panel.")), /* @__PURE__ */ React.createElement("div", { className: "waveline-viz", "aria-label": "Waveline visualization and stage tables" }, /* @__PURE__ */ React.createElement("div", { className: "waveline-doc-legend", "aria-label": "Wave legend" }, experienceWaves.map((w) => /* @__PURE__ */ React.createElement("span", { key: w.id, className: "waveline-legend-item waveline-legend-item--static" }, /* @__PURE__ */ React.createElement("i", { style: { background: w.stroke } }), /* @__PURE__ */ React.createElement("span", null, w.label)))), /* @__PURE__ */ React.createElement("figure", { className: "waveline-doc-chart" }, /* @__PURE__ */ React.createElement(WavelineCompareChart, { waves: experienceWaves }), /* @__PURE__ */ React.createElement("figcaption", null, "Curves share stages 01\u201308. Tables below hold the same stages in rows \u2014 one visualization, readable and printable.")), /* @__PURE__ */ React.createElement("div", { className: "waveline-table-scroll" }, /* @__PURE__ */ React.createElement("table", { className: "waveline-table waveline-table--intensity" }, /* @__PURE__ */ React.createElement("caption", null, "Felt intensity by stage (same values as plot height)"), /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { scope: "col" }, "Stage"), /* @__PURE__ */ React.createElement("th", { scope: "col" }, "Name"), experienceWaves.map((w) => /* @__PURE__ */ React.createElement("th", { key: w.id, scope: "col", style: { color: w.stroke } }, w.label)))), /* @__PURE__ */ React.createElement("tbody", null, stageSpine.map((spine, si) => /* @__PURE__ */ React.createElement("tr", { key: spine.id }, /* @__PURE__ */ React.createElement("th", { scope: "row" }, spine.stage), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("b", null, spine.name), /* @__PURE__ */ React.createElement("span", { className: "waveline-table__sub" }, spine.short)), experienceWaves.map((w) => {
      const st = w.stages[si];
      return /* @__PURE__ */ React.createElement("td", { key: w.id }, /* @__PURE__ */ React.createElement("span", { className: "waveline-table__intensity", style: { color: w.stroke } }, Math.round(st.intensity * 100), "%"), /* @__PURE__ */ React.createElement("span", { className: "waveline-table__sub" }, st.peakLabel));
    })))))), experienceWaves.map((wave) => /* @__PURE__ */ React.createElement("div", { key: wave.id, className: "waveline-table-block", id: `wave-${wave.id}` }, /* @__PURE__ */ React.createElement("h2", { className: "waveline-table-block__title", style: { color: wave.stroke } }, /* @__PURE__ */ React.createElement("i", { style: { background: wave.stroke } }), wave.label), /* @__PURE__ */ React.createElement("p", { className: "waveline-table-block__lede" }, wave.lede), /* @__PURE__ */ React.createElement("div", { className: "waveline-table-scroll" }, /* @__PURE__ */ React.createElement("table", { className: "waveline-table waveline-table--detail" }, /* @__PURE__ */ React.createElement("caption", null, wave.label, ": stage notes (behavior, feelings, achievements, mechanics)"), /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { scope: "col" }, "#"), /* @__PURE__ */ React.createElement("th", { scope: "col" }, "Stage"), /* @__PURE__ */ React.createElement("th", { scope: "col" }, "Peak"), /* @__PURE__ */ React.createElement("th", { scope: "col" }, "Behavior"), /* @__PURE__ */ React.createElement("th", { scope: "col" }, "Feelings"), /* @__PURE__ */ React.createElement("th", { scope: "col" }, "Achievements"), /* @__PURE__ */ React.createElement("th", { scope: "col" }, "Mechanics"))), /* @__PURE__ */ React.createElement("tbody", null, wave.stages.map((stage) => /* @__PURE__ */ React.createElement("tr", { key: `${wave.id}-${stage.id}` }, /* @__PURE__ */ React.createElement("th", { scope: "row", style: { color: wave.stroke } }, stage.stage), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("b", null, stage.name), /* @__PURE__ */ React.createElement("span", { className: "waveline-table__sub" }, stage.short)), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("b", null, stage.peakLabel), /* @__PURE__ */ React.createElement("span", { className: "waveline-table__sub" }, Math.round(stage.intensity * 100), "% intensity")), /* @__PURE__ */ React.createElement("td", null, stage.behavior), /* @__PURE__ */ React.createElement("td", null, stage.feelings), /* @__PURE__ */ React.createElement("td", null, stage.achievements), /* @__PURE__ */ React.createElement("td", null, stage.mechanics.join(" \xB7 ")))))))))), /* @__PURE__ */ React.createElement("p", { className: "waveline-share-hint" }, "Print tip: close the left sidebar (\u2039), then Print / Save as PDF. Chart and tables print together \u2014 no interaction."), /* @__PURE__ */ React.createElement("div", { className: "report-next-links" }, /* @__PURE__ */ React.createElement("a", { href: "/cosmos/primary/version1-review/" }, "\u2190 Version 1 & review"), /* @__PURE__ */ React.createElement("a", { href: "/cosmos/stakeholder-map/" }, "Next: Stakeholder map \u2192")));
  }
  var influenceTypes = [
