(() => {
  ...
  function CosmosSidebar({ active, subActive }) {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("aside", { className: "chapter-rail", "aria-label": "Cosmos reports", hidden: !open }, /* @__PURE__ */ React.createElement("div", { className: "rail-intro" }, /* @__PURE__ */ React.createElement("div", { className: "rail-intro__top" }, /* @__PURE__ */ React.createElement("p", null, "Research library"), /* @__PURE__ */ React.createElement(
      ...
      "\u2039"
    )), /* @__PURE__ */ React.createElement("h2", null, "Cosmos"), /* @__PURE__ */ React.createElement("span", null, "Spatializing asynchronous community")), /* @__PURE__ */ React.createElement("nav", { className: "chapter-rail__nav" }, /* @__PURE__ */ React.createElement("p", null, "Index"), cosmosPages.map(([id, number, label, path]) => /* @__PURE__ */ React.createElement(React.Fragment, { key: id }, /* @__PURE__ */ React.createElement("a", { className: active === id ? "active" : "", href: path }, /* @__PURE__ */ React.createElement("span", null, number), /* @__PURE__ */ React.createElement("b", null, label), /* @__PURE__ */ React.createElement("i", null, "\u2192")), reportChildren[id] && active === id && /* @__PURE__ */ React.createElement("div", { className: "rail-subnav" }, reportChildren[id].map(([subId, subNumber, subLabel, subPath]) => /* @__PURE__ */ React.createElement("a", { className: subActive === subId ? "active" : "", key: subId, href: subPath }, /* @__PURE__ */ React.createElement("span", null, subNumber), /* @__PURE__ */ React.createElement("b", null, subLabel), /* @__PURE__ */ React.createElement("i", null, "\u2197")))))))), !open && /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
  ...
  var { useEffect, useState, useRef, useCallback } = React;
  var experienceWaves = [
    {
      id: "cosmos",
      label: "Cosmos VR",
      ...
      stages: [
        ...
        },
        {
          ...
          intensity: 0.55,
          peakLabel: "optional",
          behavior: "May react, leave a short note, or save a path. Full native posting and voice posting are deferred until reading value is proven (see Making \xB7 community).",
  ...
  var phases = [
    ...
    },
    {
      ...
      outputs: ["/VR World.create", "Radius = age shells", "Proximity audio \xB7 voice posting to DB"]
    },
    {
      phase: "05",
  ...
  function CosmosFullStoryPage() {
    ...
    const [mounted, setMounted] = useState(() => /* @__PURE__ */ new Set([0, 1, 2]));
    const stageRef = useRef(null);
    useEffect(() => {
      setMounted((prev) => {
        const next = new Set(prev);
        for (let i = index2 - 1; i <= index2 + 2; i += 1) {
    ...
    const controls = /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("button", { type: "button", disabled: index2 <= 0, onClick: goPrev, "aria-label": "Previous slide" }, "\u2190"), /* @__PURE__ */ React.createElement("span", { className: "full-story-controls__count" }, index2 + 1, " / ", FULL_STORY_TOTAL), /* @__PURE__ */ React.createElement("button", { type: "button", disabled: index2 >= FULL_STORY_TOTAL - 1, onClick: goNext, "aria-label": "Next slide" }, "\u2192"), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: toggleFs }, isFs ? "Exit" : "Full"));
    return /* @__PURE__ */ React.createElement("section", { className: "report-section full-story-page", id: "full-story" }, /* @__PURE__ */ React.createElement("div", { className: "full-story-stage", ref: stageRef }, /* @__PURE__ */ React.createElement("div", { className: "full-story-deck" }, FULL_STORY_SLIDES.map(
      (slide, i) => mounted.has(i) ? /* @__PURE__ */ React.createElement(
        "img",
        {
          key: slide.src,
          className: `full-story-slide${i === index2 ? " is-active" : ""}`,
          src: slide.src,
          alt: slide.alt,
          draggable: "false",
          "aria-hidden": i === index2 ? "false" : "true"
        }
      ) : null
    )), /* @__PURE__ */ React.createElement("div", { className: "full-story-controls full-story-controls--overlay" }, controls)), /* @__PURE__ */ React.createElement("div", { className: "full-story-controls" }, controls));
  }
  var storyboardBeats = [
  ...
  function App() {
    ...
    const activeChapter = window.location.pathname.includes("/secondary") ? "secondary" : window.location.pathname.includes("/primary") ? "primary" : window.location.pathname.includes("/user-waveline") ? "user-waveline" : window.location.pathname.includes("/storyboard") ? "storyboard" : window.location.pathname.includes("/stakeholder-map") ? "stakeholder-map" : window.location.pathname.includes("/impact-analysis") ? "impact-analysis" : window.location.pathname.includes("/design-decision") ? "design-decision" : window.location.pathname.includes("/making") ? "making" : window.location.pathname.includes("/cosmos/00") || window.location.pathname.endsWith("/00/") || window.location.pathname.endsWith("/00") ? "full-story" : "intro";
    return /* @__PURE__ */ React.createElement("div", { id: "top" }, /* @__PURE__ */ React.createElement(Progress, null), /* @__PURE__ */ React.createElement(CosmosHeader, null), /* @__PURE__ */ React.createElement(CosmosSidebar, { active: activeChapter, subActive: activeChapter === "secondary" ? secondaryPage : activeChapter === "primary" ? primaryPage : void 0 }), /* @__PURE__ */ React.createElement("main", null, activeChapter === "full-story" && /* @__PURE__ */ React.createElement(CosmosFullStoryPage, null), activeChapter === "primary" && primaryPage === "expert-questionnaire" && /* @__PURE__ */ React.createElement(ExpertQuestionnaire, null), activeChapter === "primary" && primaryPage === "version1-review" && /* @__PURE__ */ React.createElement(Version1Review, null), activeChapter === "user-waveline" && /* @__PURE__ */ React.createElement(UserWavelinePage, null), activeChapter === "storyboard" && /* @__PURE__ */ React.createElement(StoryboardPage, null), activeChapter === "stakeholder-map" && /* @__PURE__ */ React.createElement(StakeholderMapPage, null), activeChapter === "impact-analysis" && /* @__PURE__ */ React.createElement(ImpactAnalysisPage, null), activeChapter === "intro" && /* @__PURE__ */ React.createElement("section", { className: "hero", id: "intro" }, /* @__PURE__ */ React.createElement("div", { className: "hero-kicker" }, /* @__PURE__ */ React.createElement("span", null, "Independent research"), /* @__PURE__ */ React.createElement("span", null, "Updated July 2026")), /* @__PURE__ */ React.createElement("div", { className: "hero-grid" }, /* @__PURE__ */ React.createElement("div", { className: "hero-copy" }, /* @__PURE__ */ React.createElement("p", { className: "eyebrow" }, "Spatializing asynchronous community"), /* @__PURE__ */ React.createElement("h1", null, "Explore ideas spatially,", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("em", null, "not doomscrolling vertically.")), /* @__PURE__ */ React.createElement("p", { className: "hero-summary" }, "Cosmos investigates whether VR can make online discussions easier to understand by rebuilding a familiar offline behavior: reading a public wall."), /* @__PURE__ */ React.createElement("a", { className: "text-link", href: "/cosmos/00/" }, "Full story (00) ", /* @__PURE__ */ React.createElement("span", null, "\u2192")), " ", /* @__PURE__ */ React.createElement("a", { className: "text-link", href: "/cosmos/secondary/" }, "Research library ", /* @__PURE__ */ React.createElement("span", null, "\u2192"))), /* @__PURE__ */ React.createElement("figure", { className: "hero-figure" }, /* @__PURE__ */ React.createElement(
      "img",
      {
