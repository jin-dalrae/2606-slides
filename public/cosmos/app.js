(() => {
  ...
  function StakeholderMapPage() {
    ...
    const title = focusMode === "structure" ? "Category structure" : focusMode === "gaps" ? activeGap ? `${nodeById[activeGap.from]?.label || activeGap.from} \u2192 ${nodeById[activeGap.to]?.label || activeGap.to}` : "One-way influence" : selectedEdge ? `${nodeById[selectedEdge.from]?.label || selectedEdge.from} \u2192 ${nodeById[selectedEdge.to]?.label || selectedEdge.to}` : focusMode === "side" ? activeNode ? activeNode.label : activeSide.shortName : focusMode === "type" ? `${activeType.label} influence` : "Stakeholder map";
    ...
    return /* @__PURE__ */ React.createElement("section", { className: "report-section stakeholder-page", id: "stakeholder-map" }, /* @__PURE__ */ React.createElement("div", { className: "stakeholder-shell", "aria-label": "Cosmos VR stakeholder influence network" }, /* @__PURE__ */ React.createElement("header", { className: "stakeholder-frame__head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "stakeholder-kicker" }, focusMode === "gaps" ? "05 \xB7 One-way gaps \xB7 where Cosmos can act" : "05 \xB7 Structure + influence"), /* @__PURE__ */ React.createElement("h1", null, title)), /* @__PURE__ */ React.createElement("p", { className: "stakeholder-lede" }, subtitle)), /* @__PURE__ */ React.createElement("div", { className: "stakeholder-frame__toolbar" }, /* @__PURE__ */ React.createElement("div", { className: "stakeholder-frame__mode-tabs", role: "tablist", "aria-label": "Focus mode" }, /* @__PURE__ */ React.createElement("button", { type: "button", className: focusMode === "structure" ? "is-active" : "", onClick: goStructure }, "Structure"), /* @__PURE__ */ React.createElement("button", { type: "button", className: focusMode === "overview" ? "is-active" : "", onClick: goOverview }, "+ Influence"), /* @__PURE__ */ React.createElement("button", { type: "button", className: focusMode === "type" ? "is-active" : "", onClick: () => goType(activeTypeId) }, "By type"), /* @__PURE__ */ React.createElement("button", { type: "button", className: focusMode === "side" ? "is-active" : "", onClick: () => goSide(activeSideId) }, "By group"), /* @__PURE__ */ React.createElement("button", { type: "button", className: focusMode === "gaps" ? "is-active" : "", onClick: goGaps }, "Gaps")), /* @__PURE__ */ React.createElement("div", { className: "stakeholder-frame__stepper" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => stepPart(-1), "aria-label": "Previous", disabled: focusMode === "structure" }, "\u2190"), /* @__PURE__ */ React.createElement("span", null, focusMode === "structure" ? "Structure" : focusMode === "gaps" ? filteredAsymmetryGaps.length ? `${gapIndex >= 0 ? gapIndex + 1 : "\u2014"} / ${filteredAsymmetryGaps.length}` : "0 gaps" : focusMode === "side" ? `${sideIndex + 1} / ${networkGraph.length}` : `${typeIndex + 1} / ${influenceTypes.length}`), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => stepPart(1), "aria-label": "Next", disabled: focusMode === "structure" }, "\u2192"), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: fitView, title: "Fit current focus in view" }, "Fit"))), /* @__PURE__ */ React.createElement("div", { className: "stakeholder-map-legend", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("span", { className: "stakeholder-map-legend__item" }, /* @__PURE__ */ React.createElement("i", { className: "stakeholder-map-legend__rel" }), "Structure (gray): hub \u2192 category \u2192 brand"), showInfluence && focusMode !== "gaps" && /* @__PURE__ */ React.createElement("span", { className: "stakeholder-map-legend__item" }, /* @__PURE__ */ React.createElement("i", { className: "stakeholder-map-legend__inf" }), "Influence (color): click an edge"), focusMode === "gaps" && /* @__PURE__ */ React.createElement("span", { className: "stakeholder-map-legend__item" }, /* @__PURE__ */ React.createElement("i", { className: "stakeholder-map-legend__inf" }), "One-way only \xB7 click a card or edge")), focusMode === "gaps" && /* @__PURE__ */ React.createElement("div", { className: "stakeholder-frame__gap-filters", "aria-label": "Asymmetry gap filters" }, /* @__PURE__ */ React.createElement("div", { className: "stakeholder-frame__gap-filter-row", role: "tablist", "aria-label": "Opportunity kind" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
  ...
  function StakeholderInfluenceStory({ onGoGaps }) {
    ...
    return /* @__PURE__ */ React.createElement("article", { className: "stakeholder-story", id: "influence-story", "aria-label": "Stakeholder influence story" }, /* @__PURE__ */ React.createElement("header", { className: "stakeholder-story__header" }, /* @__PURE__ */ React.createElement("p", { className: "stakeholder-story__kicker" }, "05b \xB7 Influence story"), /* @__PURE__ */ React.createElement("h2", null, "How influence actually moves"), /* @__PURE__ */ React.createElement("p", { className: "stakeholder-story__lede" }, "The graph has ", edgeCount, " typed edges. Strategy does not need all of them named out loud. It needs the ", /* @__PURE__ */ React.createElement("strong", null, reciprocalCount, " closed loops"), ", the ~", oneWayCount, " one-way forces folded into clear families, and an honest list of what is still missing.")), /* @__PURE__ */ React.createElement("section", { className: "stakeholder-story__section" }, /* @__PURE__ */ React.createElement("h3", null, "How to read the map"), /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("strong", null, "Reciprocal"), " means influence runs both ways \u2014 money for pressure, attention for contribution, comparison for comparison. ", /* @__PURE__ */ React.createElement("strong", null, "One-way"), " means A shapes B with no reverse edge on the map. That can be normal (a headset does not listen to one app) or strategic (nothing answers Discord\u2019s claim on \u201Cplace\u201D). Similar edges are the same force under different brand names; we merge them."), /* @__PURE__ */ React.createElement("p", null, "The people in view are not \u201CVR early adopters\u201D as a type. They are hybrid workers in Slack and Notion, parents with five-minute pockets, students who still open Reddit for depth, and headset owners who mostly launch play-social apps because the store taught them that is what the device is for. Store cuts, AI invoices, and biometric policy are ordinary constraints.")), /* @__PURE__ */ React.createElement("section", { className: "stakeholder-story__section" }, /* @__PURE__ */ React.createElement("div", { className: "stakeholder-story__section-head" }, /* @__PURE__ */ React.createElement("h3", null, "I \xB7 Seven closed loops"), /* @__PURE__ */ React.createElement("p", null, "These are the only fully reciprocal pairs. Everything else runs one direction.")), /* @__PURE__ */ React.createElement("div", { className: "stakeholder-story__reciprocal-list" }, influenceStoryReciprocals.map((loop) => /* @__PURE__ */ React.createElement("article", { key: loop.id, className: "stakeholder-story__reciprocal" }, /* @__PURE__ */ React.createElement("header", null, /* @__PURE__ */ React.createElement("h4", null, loop.title), /* @__PURE__ */ React.createElement("p", { className: "stakeholder-story__thesis" }, loop.thesis)), /* @__PURE__ */ React.createElement("p", null, loop.body), loop.mergeNote && /* @__PURE__ */ React.createElement("p", { className: "stakeholder-story__merge" }, /* @__PURE__ */ React.createElement("strong", null, "Merge."), " ", loop.mergeNote)))), /* @__PURE__ */ React.createElement("p", { className: "stakeholder-story__pull" }, "Missing from the closed set: Cosmos \u2194 readers, a paid-user feedback loop into product, and community \u2192 store featuring. The product still mostly talks at people. The funded antagonist (ads \u2194 feeds) already talks to itself.")), /* @__PURE__ */ React.createElement("section", { className: "stakeholder-story__section" }, /* @__PURE__ */ React.createElement("div", { className: "stakeholder-story__section-head" }, /* @__PURE__ */ React.createElement("h3", null, "II \xB7 One-way forces (twelve families)"), /* @__PURE__ */ React.createElement("p", null, "All ~", oneWayCount, " one-way pairs matter less than the forces behind them. Each arc below collapses similar edges into one force and one move for Cosmos.")), /* @__PURE__ */ React.createElement("div", { className: "stakeholder-story__arc-list" }, influenceStoryOneWayArcs.map((arc) => /* @__PURE__ */ React.createElement("article", { key: arc.id, className: "stakeholder-story__arc" }, /* @__PURE__ */ React.createElement("header", null, /* @__PURE__ */ React.createElement("span", { className: "stakeholder-story__arc-num" }, arc.number), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "stakeholder-story__arc-meta" }, arc.clusterFlow, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true" }, " \xB7 "), arc.mergeLabel), /* @__PURE__ */ React.createElement("h4", null, arc.title))), /* @__PURE__ */ React.createElement("ul", { className: "stakeholder-story__pairs" }, arc.pairs.map((line) => /* @__PURE__ */ React.createElement("li", { key: line }, line))), /* @__PURE__ */ React.createElement("p", null, arc.body), /* @__PURE__ */ React.createElement("p", { className: "stakeholder-story__opportunity" }, /* @__PURE__ */ React.createElement("strong", null, "Move."), " ", arc.opportunity))))), /* @__PURE__ */ React.createElement("section", { className: "stakeholder-story__section" }, /* @__PURE__ */ React.createElement("div", { className: "stakeholder-story__section-head" }, /* @__PURE__ */ React.createElement("h3", null, "III \xB7 What to merge"), /* @__PURE__ */ React.createElement("p", null, "If two arrows teach the same lesson, keep one strategic object. The map can stay detailed; strategy should not treat Meta\u2019s cut and Pico\u2019s cut as different philosophies of power.")), /* @__PURE__ */ React.createElement("div", { className: "stakeholder-story__merge-grid" }, influenceStoryMerges.map((row) => /* @__PURE__ */ React.createElement("article", { key: row.title }, /* @__PURE__ */ React.createElement("h4", null, row.title), /* @__PURE__ */ React.createElement("p", { className: "stakeholder-story__merge-items" }, row.items), /* @__PURE__ */ React.createElement("p", null, row.action))))), /* @__PURE__ */ React.createElement("section", { className: "stakeholder-story__section stakeholder-story__section--close" }, /* @__PURE__ */ React.createElement("h3", null, "What to remember"), /* @__PURE__ */ React.createElement("p", null, "Closed loops are rare: readers with contributors, team with stores, ads with feeds, Discord as the mirror of place. Almost everything else is one-way \u2014 hardware on bodies, feeds on habits, policy on voice, capital on tempo, press on first impressions, empty walls on hope."), /* @__PURE__ */ React.createElement("p", null, "Strategy is not \u201Cdraw reverse arrows on everything.\u201D It is choosing which reverse paths Cosmos can earn: continuity for reader loyalty, contribution that feels like building a place, proof for publishers, and sessions people can end without guilt. Gaps mode is the checklist; this section is the frame."), /* @__PURE__ */ React.createElement("p", { className: "stakeholder-story__cta" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: onGoGaps }, "Open Gaps"), /* @__PURE__ */ React.createElement("span", null, majorAsymmetryGaps.length, " major one-way pairs, tagged for marketing, product, targeting, partnership, policy, or defense."))));
  }
  var impactHorizons = [
    {
      id: "session",
