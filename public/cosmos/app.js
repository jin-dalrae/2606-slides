(() => {
  ...
  var influenceEdges = [
    ...
    { from: "academic-labs", to: "universities", type: "functional", note: "Research labs open university classroom and study pilots." },
    { from: "academic-labs", to: "design-art-schools", type: "identity", note: "Design schools treat spatial discourse as studio infrastructure." },
